...
public class AccountController {
	...
	@GetMapping("/search")
	public ResponseEntity<Account> find(@QueryParam("firstName") String firstName,@QueryParam ("accountId") Long accountId ){
		Account account = service.search(firstName,accountId);
